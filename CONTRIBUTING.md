...
[Ory claude-plugins Discussions](https://github.com/orgs/ory/discussions) or the
...
[open a well-written issue or discussion](https://github.com/ory/claude-plugins/issues):
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/claude-plugins/blob/master/.github/workflows/conventional_commits.yml)
...
maintain the quality and reliability of Ory claude-plugins, please follow these
guidelines:
...
git clone git@github.com:ory/claude-plugins.git
